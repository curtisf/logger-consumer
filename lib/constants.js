// Straight up taken from Eris, thanks abal
...
module.exports.DEFAULT_USER_AVATAR = discrim => `${module.exports.CDN_URL}/embeds/avatars/${discrim}`
module.exports.USER_AVATAR = (userID, avatar) => `${module.exports.CDN_URL}/avatars/${userID}/${avatar}`
